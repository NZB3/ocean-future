...
from .base import db
from .schemas import CustomerCreate, AnimalsCreate, TicketsCreate, MailCreate
...
async def create_customer(costumer: CustomerCreate, message: MailCreate):
    """
    При вводе текста в поле "text" форматируйте его сразу с \\n
    """
    send_mail.delay(message.me, costumer.mail, message.text, message.subject)
